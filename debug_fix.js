...
// Overwrite admin-action.js with a version that alerts the exact status and response text
const debugCode = `
...
fs.writeFileSync('admin-action.js', debugCode);
console.log('admin-action.js updated with deep debug alerts!');
